...
const musicpages = new APlayer({
    ...
    audio: [
    {
        ...
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/shimotsukin/KDSD-20017/disc1/07.lrc',
        theme: '#67AE87'
    }, {
        name: "Kaleidoscope",
        artist: '霜月はるか',
        ...
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/shimotsukin/KDSD-20017/disc2/10.lrc',
        theme: '#FFA5DE'
    }, {
        name: "明日、晴れるかな",
        artist: '三澤紗千香',
        ...
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/others/10.lrc',
        theme: '#E1BCBC'
    }, {
        name: "春日影",
        artist: "CRYCHIC",
        ...
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/others/09.lrc',
        theme: '#8DABC2'
    }, {
        name: "アルカテイル",
        artist: '铃木このみ',
        ...
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/summer_pockets/KSLM-0151/11.lrc',
        theme: '#E1BCBC'
    }, {
    ...
    // Others
    {
        ...
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/others/01.lrc',
        theme: '#C69480'
    }, {
        name: "雪の華",
        artist: '中島美嘉',
        ...
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/others/02.lrc',
        theme: '#484632'
    }, {
        name: "雪の華",
        artist: '南條愛乃',
        ...
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/others/03.lrc',
        theme: '#AEA191'
    }, {
        name: "銀の龍の背に乗って",
        artist: '佐藤聡美',
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-02@1.0.0/others/umca-10015.jpg',
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/others/04.lrc',
        theme: '#AEA191'
    }, {
        name: "空も飛べるはず",
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-02@1.0.0/others/umca-10015.jpg',
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/others/05.lrc',
        theme: '#AEA191'
    }, {
        name: "キスのひとつで",
        artist: '佐咲紗花',
    ...
    // fripSide
    {
        ...
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/fripSide/GNCA-1582/30.lrc',
        theme: '#972C3F'
    }, {
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-04@1.0.2/fripSide/GNCA-1582/cover.jpg',
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/fripSide/GNCA-1582/29.lrc',
        theme: '#972C3F'
    }, {
        name: "future gazer",
        artist: 'fripSide',
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-04@1.0.2/fripSide/GNCA-1582/cover.jpg',
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/fripSide/GNCA-1582/28.lrc',
        theme: '#972C3F'
    }, {
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-04@1.0.2/fripSide/GNCA-1582/cover.jpg',
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/fripSide/GNCA-1582/27.lrc',
        theme: '#972C3F'
    }, {
        name: "sister's noise",
        artist: 'fripSide',
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-04@1.0.2/fripSide/GNCA-1582/cover.jpg',
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/fripSide/GNCA-1582/23.lrc',
        theme: '#972C3F'
    }, {
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-04@1.0.2/fripSide/GNCA-1582/cover.jpg',
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/fripSide/GNCA-1582/22.lrc',
        theme: '#972C3F'
    }, {
        name: "final phase",
        artist: 'fripSide',
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-04@1.0.2/fripSide/GNCA-1582/cover.jpg',
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/fripSide/GNCA-1582/03.lrc',
        theme: '#972C3F'
    }, {
        name: "dual existence",
        artist: 'fripSide',
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-04@1.0.2/fripSide/GNCA-1582/cover.jpg',
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/fripSide/GNCA-1582/01.lrc',
        theme: '#972C3F'
    }, {
        name: "We Rise",
        artist: 'fripSide',
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-04@1.0.2/fripSide/GNCA-1582/cover.jpg',
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/fripSide/GNCA-1582/02.lrc',
        theme: '#972C3F'
    }, {
        name: "Hesitation Snow",
        artist: 'fripSide',
        url: 'https://unpkg.com/lokocdnms-pkg-04@1.0.2/fripSide/GNCA-1582/25.m4a',
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/fripSide/GNCA-1582/25.lrc',
        cover: 'https://unpkg.com/lokocdnms-pkg-04@1.0.2/fripSide/GNCA-1582/cover.jpg',
        theme: '#972C3F'
    },
    // Darling in the FranXX
    {
        ...
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/others/07.lrc',
        theme: '#46718B'
    },
    // Re:0
    {
        ...
        lrc: 'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/others/06.lrc',
        theme: '#C9AFF8'
    },
    // About Anime Madoka
    {
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/madoka/SECL-946/01.lrc',
        theme: '#FFC0D3'
    }, {
        name: "また あした",
        artist: '鹿目まどか (悠木碧)',
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/madoka/SVWC-7980/23.lrc',
        theme: '#FFC0D3'
    }, {
        name: "ルミナス",
        artist: 'ClariS',
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/madoka/SECL-1196/01.lrc',
        theme: '#FFC0D3'
    }, {
        name: "Friends",
        artist: 'ClariS',
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-03@1.0.0/madoka/SECL-1196/cover.jpg',
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/madoka/SECL-1196/02.lrc',
        theme: '#FFC0D3'
    }, {
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/madoka/SECL-1416/04.lrc',
        theme: '#FFC0D3'
    }, {
        name: "君の銀の庭",
        artist: 'Kalafina',
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/madoka/SECL-1422/01.lrc',
        theme: '#0066CC'
    },
    // ATRI
    {
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-01@1.0.1/atri/cover.jpg',
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/atri/21.lrc',
        theme: '#7CD5F8'
    }, {
        name: "Dear Moments",
        artist: '赤尾ひかる',
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-01@1.0.1/atri/cover.jpg',
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/atri/24.lrc',
        theme: '#7CD5F8'
    },
    // LoveLive
    {
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/02.lrc',
        theme: '#E1E1E1'
    }, {
        name: "ススメ→トゥモロウ",
        artist: "高坂穂乃果...",
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/03.lrc',
        theme: '#FFAE2E'
    }, {
        name: "START：DASH！！",
        artist: "高坂穂乃果...",
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-05@1.0.1/lovelive/us/03.jpg',
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/04.lrc',
        theme: '#7AEBF9'
    }, {
        name: "僕らは今のなかで",
        artist: "μ's",
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/05.lrc',
        theme: '#FFAE2E'
    }, {
        name: "きっと青春が聞こえる",
        artist: "μ's",
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/07.lrc',
        theme: '#FFAE2E'
    }, {
        name: "それは僕たちの奇跡",
        artist: "μ's",
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/08.lrc',
        theme: '#FFAE2E'
    }, {
        name: "ユメノトビラ",
        artist: "μ's",
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/09.lrc',
        theme: '#8DF9F6'
    }, {
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/06.lrc',
        theme: '#FFAE2E'
    }, {
        name: "Love wing bell",
        artist: "μ's",
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-05@1.0.1/lovelive/us/06.jpg',
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/10.lrc',
        theme: '#FFADC0'
    }, {
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/11.lrc',
        theme: '#FFADC0'
    }, {
        name: "どんなときもずっと",
        artist: "μ's",
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/12.lrc',
        theme: '#FFB800'
    }, {
        name: "ステージへと続く道",
        artist: '藤澤慶昌',
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/16.lrc',
        theme: '#FF9B00'
    }, {
        name: "僕たちはひとつの光",
        artist: "μ's",
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/17.lrc',
        theme: '#F2C7D3'
    }, {
        name: "冬がくれた予感",
        artist: "BiBi",
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/13.lrc',
        theme: '#DAFFF9'
    }, {
        name: "LOVELESS WORLD",
        artist: "μ's",
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/14.lrc',
        theme: '#DAFFF9'
    }, {
        name: "MOMENT RING",
        artist: "μ's",
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/18.lrc',
        theme: '#FFB800'
    }, {
        name: "さようならへさよなら！",
        artist: "μ's",
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-05@1.0.1/lovelive/us/15.jpg',
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/us/15.lrc',
        theme: '#FFB800'
    }, {
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/aqours/01.lrc',
        theme: '#4DCAFF'
    }, {
        name: "虹色Passions!",
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/nijigasaki/01.lrc',
        theme: '#D7D7D7'
    }, {
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/nijigasaki/02.lrc',
        theme: '#D7D7D7'
    }, {
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/liella/01.lrc',
        theme: '#FF5757'
    }, {
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/lovelive/01.lrc',
        theme: '#EE6A82'
    },
    // 227
    {
    ...
    // MyGO!!!!!
    {
        ...
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/bangdream/mygo/BRMM-10716/02.lrc',
        theme: '#8DABC2'
    }, {
        name: "潜在表明",
        artist: "MyGO!!!!!",
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-02@1.0.0/bangdream/mygo/BRMM-10716/cover.jpg',
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/bangdream/mygo/BRMM-10716/06.lrc',
        theme: '#8DABC2'
    }, {
        name: "春日影",
        artist: "MyGO!!!!!",
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-02@1.0.0/bangdream/mygo/BRMM-10716/cover.jpg',
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/bangdream/mygo/BRMM-10716/08.lrc',
        theme: '#8DABC2'
    }, {
        name: "詩超絆",
        artist: "MyGO!!!!!",
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-02@1.0.0/bangdream/mygo/BRMM-10716/cover.jpg',
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/bangdream/mygo/BRMM-10716/09.lrc',
        theme: '#8DABC2'
    }, {
        name: "栞",
        artist: "MyGO!!!!!",
        ...
        cover: 'https://unpkg.com/lokocdnms-pkg-02@1.0.0/bangdream/mygo/BRMM-10716/cover.jpg',
        lrc:'https://unpkg.com/lokocdnms-pkg-exlrc@1.0.5/bangdream/mygo/BRMM-10716/13.lrc',
        theme: '#F8D9B6'
    }
    ]
});
